...
const long LEDdelay=10;               //(milliseconds)LED变化时间间隔
int fade = 1;  //呼吸效果
...
/**********************************************/ 
  ...
  dcMotorIni(0,1);     //分别对应电机的默认转动方向,改变0/1变换方向
  
/**********************************************/
//  setupOTA("MyOTA_Wemos", mySSID, myPASSWORD);
/**********************************************/  
}
